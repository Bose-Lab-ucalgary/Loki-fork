"""
This code is from the MCAT repository (https://github.com/mahmoodlab/MCAT) 
without modifications. We thank the authors for their original work.
"""

# loss functions from MCAT package
...
def ce_loss(hazards, S, Y, c, alpha=0.4, eps=1e-7):
    ...
    ce_l = -c * torch.log(
        torch.gather(S, 1, Y).clamp(min=eps)
